...
def init_db():
    ...
    vidhyarthi_khaana_items = [
        ...
        (1, 'Karbooja / Musk Melon Juice', 'Karbooja / Musk Melon Juice', 45.0, 'beverage', 'muskmelon_juice_new.png', 'FRESH JUICE'),
        ...
        (1, 'Mango', 'Mango', 60.0, 'beverage', 'mango_juice_new.png', 'FRESH JUICE'),
        ...
        (1, 'Bread Jam', 'Bread Jam', 40.0, 'veg', 'bread_jam_new.png', 'Sandwich'),
        (1, 'Veg Burger', 'Veg Burger', 50.0, 'veg', 'veg_burger_sip.png', 'Sandwich'),
        (1, 'Veg Cheese Burger', 'Veg Cheese Burger', 60.0, 'veg', 'veg_burger_sip.png', 'Sandwich'),
        (1, 'Veg Sandwich', 'Veg Sandwich', 50.0, 'veg', 'veg_sandwich_new.png', 'Sandwich'),
        (1, 'Veg Grill Sandwich', 'Veg Grill Sandwich', 60.0, 'veg', 'veg_grill_sandwich_new.png', 'Sandwich'),
        (1, 'Cheese Grill Sandwich', 'Cheese Grill Sandwich', 65.0, 'veg', 'cheese_frill_sandwich_new.png', 'Sandwich'),
        (1, 'Onion Cheese Grill', 'Onion Cheese Grill', 60.0, 'veg', 'onion_cheese_grill_new.png', 'Sandwich'),
        (1, 'Chilly Cheese Grill', 'Chilly Cheese Grill', 60.0, 'veg', 'chilli_cheese_sandwich_new.png', 'Sandwich'),
        (1, 'Potato Cheese Grill', 'Potato Cheese Grill', 60.0, 'veg', 'potato_cheese_grill_new.png', 'Sandwich'),
        (1, 'Potato Onion Cheese Grill', 'Potato Onion Cheese Grill', 60.0, 'veg', 'potato_cheese_grill_new.png', 'Sandwich'),
        (1, 'Paneer Veg Grill', 'Paneer Veg Grill', 60.0, 'veg', 'paneer_veg_grill_new.png', 'Sandwich'),
        (1, 'Paneer Cheese Grill', 'Paneer Cheese Grill', 65.0, 'veg', 'paneer_veg_grill_new.png', 'Sandwich'),
        (1, 'Sweet Corn Sandwich', 'Sweet Corn Sandwich', 60.0, 'veg', 'sweet_corn_sandwich_new.png', 'Sandwich'),
        (1, 'Sweet Corn Cheese Sandwich', 'Sweet Corn Cheese Sandwich', 65.0, 'veg', 'sweet_corn_sandwich_new.png', 'Sandwich'),
        (1, 'Babycorn Sandwich', 'Babycorn Sandwich', 60.0, 'veg', 'babycorn_sandwich_new.png', 'Sandwich'),
        (1, 'Babycorn Cheese Sandwich', 'Babycorn Cheese Sandwich', 65.0, 'veg', 'babycorn_sandwich_new.png', 'Sandwich'),
        (1, 'Mushroom Cheese Sandwich', 'Mushroom Cheese Sandwich', 65.0, 'veg', 'mushroom_cheese_sandwich_new.png', 'Sandwich'),

        (1, 'Veg Maggie', 'Veg Maggie', 45.0, 'veg', 'masala_maggi_new.png', 'Veg Maggie'),
        (1, 'Veg Fry Maggie', 'Veg Fry Maggie', 50.0, 'veg', 'masala_maggi_new.png', 'Veg Maggie'),
        (1, 'Veg Maggie with Cheese', 'Veg Maggie with Cheese', 55.0, 'veg', 'masala_maggi_new.png', 'Veg Maggie'),
        (1, 'Veg Fry Maggie with Cheese', 'Veg Fry Maggie with Cheese', 60.0, 'veg', 'masala_maggi_new.png', 'Veg Maggie'),
        (1, 'Paneer Maggie', 'Paneer Maggie', 60.0, 'veg', 'paneer_masala_maggi_new.png', 'Veg Maggie'),
        (1, 'Paneer Maggie with Cheese', 'Paneer Maggie with Cheese', 65.0, 'veg', 'paneer_masala_maggi_new.png', 'Veg Maggie'),
        (1, 'Sweet Corn Maggie', 'Sweet Corn Maggie', 55.0, 'veg', 'corn_masala_maggi_new.png', 'Veg Maggie'),
        (1, 'Sweet Corn Maggie with Cheese', 'Sweet Corn Maggie with Cheese', 60.0, 'veg', 'corn_masala_maggi_new.png', 'Veg Maggie'),
        (1, 'Baby Corn Veg Maggie', 'Baby Corn Veg Maggie', 60.0, 'veg', 'babycorn_masala_maggi_new.png', 'Veg Maggie'),
        (1, 'Baby Corn Maggie with Cheese', 'Baby Corn Maggie with Cheese', 65.0, 'veg', 'babycorn_masala_maggi_new.png', 'Veg Maggie'),
        (1, 'Special Veg Fry Maggie', 'Special Veg Fry Maggie', 70.0, 'veg', 'masala_maggi_new.png', 'Veg Maggie'),
        (1, 'Egg Fry Maggie', 'Egg Fry Maggie', 60.0, 'non-veg', 'masala_maggi_new.png', 'Egg Maggie'),
        (1, 'Boiled Egg Maggie', 'Boiled Egg Maggie', 60.0, 'non-veg', 'masala_maggi_new.png', 'Egg Maggie'),
        (1, 'Egg Fry Maggie with Cheese', 'Egg Fry Maggie with Cheese', 65.0, 'non-veg', 'masala_maggi_new.png', 'Egg Maggie'),
        (1, 'Paneer Egg Fry Maggie', 'Paneer Egg Fry Maggie', 70.0, 'non-veg', 'paneer_masala_maggi_new.png', 'Egg Maggie'),
        (1, 'Paneer Egg Fry Maggie with Cheese', 'Paneer Egg Fry Maggie with Cheese', 75.0, 'non-veg', 'paneer_masala_maggi_new.png', 'Egg Maggie'),
        (1, 'Mushroom Egg Fry Maggie', 'Mushroom Egg Fry Maggie', 65.0, 'non-veg', 'masala_maggi_new.png', 'Egg Maggie'),
        (1, 'Mushroom Egg Fry Maggie with Cheese', 'Mushroom Egg Fry Maggie with Cheese', 70.0, 'non-veg', 'masala_maggi_new.png', 'Egg Maggie'),
        (1, 'Corn Egg Fry Maggie', 'Corn Egg Fry Maggie', 65.0, 'non-veg', 'corn_masala_maggi_new.png', 'Egg Maggie'),
        (1, 'Corn Egg Fry Maggie with Cheese', 'Corn Egg Fry Maggie with Cheese', 70.0, 'non-veg', 'corn_masala_maggi_new.png', 'Egg Maggie'),
        (1, 'Baby Corn Egg Fry Maggie', 'Baby Corn Egg Fry Maggie', 65.0, 'non-veg', 'babycorn_masala_maggi_new.png', 'Egg Maggie'),
        (1, 'Baby Corn Egg Fry Maggie with Cheese', 'Baby Corn Egg Fry Maggie with Cheese', 70.0, 'non-veg', 'babycorn_masala_maggi_new.png', 'Egg Maggie'),
        (1, 'Special Egg Fry Maggie', 'Special Egg Fry Maggie', 80.0, 'non-veg', 'masala_maggi_new.png', 'Egg Maggie'),
    ]
    ...
    gowdas_canteen_items = [
        ...
        # PASTA / MAGGI PASTA
        (2, 'Tomato Pasta', 'Tomato Pasta', 58.0, 'veg', 'tomato_pasta_new.png', 'PASTA / MAGGI PASTA'),
        (2, 'Masala Pasta', 'Masala Pasta', 58.0, 'veg', 'masala_pasta_new.png', 'PASTA / MAGGI PASTA'),
        (2, 'Mushroom Pasta', 'Mushroom Pasta', 58.0, 'veg', 'mushroom_pasta_new.png', 'PASTA / MAGGI PASTA'),
        (2, 'Cheese Pasta', 'Cheese Pasta', 78.0, 'veg', 'cheese_pasta_new.png', 'PASTA / MAGGI PASTA'),
        (2, 'Extra Cheese', 'Extra Cheese', 20.0, 'veg', 'extra_cheese_new.png', 'PASTA / MAGGI PASTA'),
        ...
        (2, 'Egg Puff', 'Egg Puff', 25.0, 'non-veg', 'egg_puff_new.png', 'EGG ITEMS'),
        (2, 'Egg Puff Cheese', 'Egg Puff with Cheese', 35.0, 'non-veg', 'egg_puff_new.png', 'EGG ITEMS'),
        (2, 'Bun Butter Egg Puff', 'Bun Butter Egg Puff', 45.0, 'non-veg', 'egg_puff_new.png', 'EGG ITEMS'),
        (2, 'Bun Butter Egg Puff Cheese', 'Bun Butter Egg Puff with Cheese', 55.0, 'non-veg', 'egg_puff_new.png', 'EGG ITEMS'),
        
        # BURGER
        (2, 'Veg Burger Plain', 'Veg Burger Plain', 35.0, 'veg', 'veg_burger_sip.png', 'BURGER'),
        (2, 'Veg Burger Cheese', 'Veg Burger with Cheese', 50.0, 'veg', 'veg_burger_sip.png', 'BURGER'),
        (2, 'Veg Burger Cheese + Chips', 'Veg Burger with Cheese and Chips', 50.0, 'veg', 'veg_burger_sip.png', 'BURGER'),
        (2, 'Paneer Burger', 'Paneer Burger', 50.0, 'veg', 'paneer_burger_sip.png', 'BURGER'),
        (2, 'Paneer Burger Cheese', 'Paneer Burger with Cheese', 65.0, 'veg', 'paneer_burger_sip.png', 'BURGER'),
        (2, 'Chicken Burger', 'Chicken Burger', 75.0, 'non-veg', 'veg_burger_sip.png', 'BURGER'),
        (2, 'Chicken Burger with Cheese', 'Chicken Burger with Cheese', 87.0, 'non-veg', 'veg_burger_sip.png', 'BURGER'),
        ...
        # SAMOSA
        (2, 'Samosa', 'Samosa', 20.0, 'veg', 'samosa_new.png', 'SAMOSA'),
        (2, 'Samosa Chat Masala', 'Samosa Chat Masala', 40.0, 'veg', 'samosa_chaat_new.png', 'SAMOSA'),
        (2, 'Bun Samosa Plain', 'Bun Samosa Plain', 30.0, 'veg', 'bun_samosa_new.png', 'SAMOSA'),
        (2, 'Bun Samosa Cheese', 'Bun Samosa with Cheese', 45.0, 'veg', 'bun_samosa_new.png', 'SAMOSA'),
        
        # PUFFS
        (2, 'Veg Puff', 'Veg Puff', 25.0, 'veg', 'veg_puff_new.png', 'PUFFS'),
        (2, 'Veg Puff Cheese', 'Veg Puff with Cheese', 35.0, 'veg', 'veg_puff_new.png', 'PUFFS'),

        (2, 'Paneer Puff', 'Paneer Puff', 50.0, 'veg', 'paneer_puff_new.png', 'PUFFS'),
        (2, 'Paneer Puff Cheese', 'Paneer Puff with Cheese', 60.0, 'veg', 'paneer_puff_new.png', 'PUFFS'),
        (2, 'Paneer Puff Cheese + Chips', 'Paneer Puff with Cheese and Chips', 75.0, 'veg', 'paneer_puff_new.png', 'PUFFS'),
        (2, 'Chicken Puff', 'Chicken Puff', 50.0, 'non-veg', 'chicken_puff_new.png', 'PUFFS'),
        (2, 'Chicken Puff Cheese', 'Chicken Puff with Cheese', 60.0, 'non-veg', 'chicken_puff_new.png', 'PUFFS'),
        (2, 'Chicken Puff Cheese + Chips', 'Chicken Puff with Cheese and Chips', 80.0, 'non-veg', 'chicken_puff_new.png', 'PUFFS'),
        
        # MOMOS
        (2, 'Veg Momos', 'Veg Momos', 65.0, 'veg', 'momos_new.png', 'MOMOS'),
        (2, 'Chicken Momos', 'Chicken Momos', 75.0, 'non-veg', 'momos_new.png', 'MOMOS'),
        
        # BUN SECTION
        (2, 'Bun Butter Jam', 'Bun Butter Jam', 25.0, 'veg', 'bread_jam_new.png', 'BUN SECTION'),
        (2, 'Bun Butter Jam Bread Toast', 'Bun Butter Jam Bread Toast', 30.0, 'veg', 'bread_jam_new.png', 'BUN SECTION'),
        (2, 'Bun Masala', 'Bun Masala', 35.0, 'veg', 'bun_masala_new.png', 'BUN SECTION'),
        (2, 'Bun Masala Cheese', 'Bun Masala with Cheese', 45.0, 'veg', 'bun_masala_new.png', 'BUN SECTION'),
        
        # SOFT DRINKS & BEVERAGES
        (2, 'Coca Cola', 'Coca Cola', 20.0, 'beverage', 'coke_new.png', 'SOFT DRINKS & BEVERAGES'),
        (2, 'Thumbs Up', 'Thumbs Up', 20.0, 'beverage', 'thumbs_up_new.png', 'SOFT DRINKS & BEVERAGES'),
        (2, 'Mountain Dew', 'Mountain Dew', 20.0, 'beverage', 'mountain_dew_new.png', 'SOFT DRINKS & BEVERAGES'),
        (2, 'Sprite', 'Sprite', 20.0, 'beverage', 'sprite_new.png', 'SOFT DRINKS & BEVERAGES'),
        (2, 'Paper Boat', 'Paper Boat', 25.0, 'beverage', 'paper_boat_new.png', 'SOFT DRINKS & BEVERAGES'),
        (2, 'Tropical Juice / Fruit Mix', 'Tropical Juice / Fruit Mix', 25.0, 'beverage', 'fresh_juice_new.png', 'SOFT DRINKS & BEVERAGES'),
        (2, 'Fresh Juices', 'Fresh Juices', 40.0, 'beverage', 'fresh_juice_new.png', 'SOFT DRINKS & BEVERAGES'),
    ...
    sip_snack_cafe_items = [
        ...
        (3, 'Anar', 'Fresh Pomegranate Juice', 50.0, 'beverage', 'anar_juice_new.png', 'FRESH JUICE'),
        ...
        (3, 'Apple', 'Fresh Apple Juice', 50.0, 'beverage', 'apple_juice_new.png', 'FRESH JUICE'),
        ...
        (3, 'Kiwi Lime', 'Kiwi Lime Juice', 40.0, 'beverage', 'kiwi_lime_juice_new.png', 'FRESH JUICE'),
        ...
        # ICE CREAM
        (3, 'Vanilla', 'Vanilla Ice Cream', 25.0, 'beverage', 'vanilla_icecream_new.png', 'ICE CREAM'),
        (3, 'Chocolate', 'Chocolate Ice Cream', 30.0, 'beverage', 'chocolate_icecream_new.png', 'ICE CREAM'),
        (3, 'Strawberry', 'Strawberry Ice Cream', 30.0, 'beverage', 'strawberry_icecream_new.png', 'ICE CREAM'),
        (3, 'Butterscotch', 'Butterscotch Ice Cream', 30.0, 'beverage', 'butterscotch_icecream_new.png', 'ICE CREAM'),
        ...
        # BURGERS
        (3, 'Veg Burger', 'Veg Burger', 50.0, 'veg', 'veg_burger_sip.png', 'BURGERS'),
        (3, 'Veg Cheese Burger', 'Veg Cheese Burger', 60.0, 'veg', 'veg_burger_sip.png', 'BURGERS'),
        (3, 'Veg Special Burger', 'Veg Special Burger', 70.0, 'veg', 'veg_burger_sip.png', 'BURGERS'),
        (3, 'Paneer Burger', 'Paneer Burger', 50.0, 'veg', 'paneer_burger_sip.png', 'BURGERS'),
        (3, 'Paneer Cheese Burger', 'Paneer Cheese Burger', 60.0, 'veg', 'paneer_burger_sip.png', 'BURGERS'),
        (3, 'Zinger Burger', 'Zinger Burger', 60.0, 'veg', 'zinger_burger_sip.png', 'BURGERS'),
        (3, 'Zinger Mushroom Burger', 'Zinger Mushroom Burger', 80.0, 'veg', 'zinger_burger_sip.png', 'BURGERS'),
        (3, 'Double Beamer', 'Double Beamer Burger', 80.0, 'veg', 'double_burger_sip.png', 'BURGERS'),
        
        # SNACKS
        (3, 'Veg Cutlet', 'Veg Cutlet', 30.0, 'veg', 'veg_cutlet_new.png', 'SNACKS'),
        (3, 'Potato Twisters', 'Potato Twisters', 60.0, 'veg', 'potato_twisters_new.png', 'SNACKS'),
        (3, 'Falafel Nuggets', 'Falafel Nuggets', 50.0, 'veg', 'falafel_nuggets_new.png', 'SNACKS'),
        (3, 'Veg Nuggets Plate', 'Veg Nuggets Plate', 50.0, 'veg', 'veg_nuggets_new.png', 'SNACKS'),
        (3, 'Peri Peri Fries', 'Peri Peri Fries', 50.0, 'veg', 'peri_peri_fries_new.png', 'SNACKS'),
        (3, 'French Fries', 'French Fries', 50.0, 'veg', 'french_fries_new.png', 'SNACKS'),
        (3, 'Vada Pav', 'Vada Pav', 30.0, 'veg', 'vada_pav_new.png', 'SNACKS'),
        
        # SANDWICH
        (3, 'Veg Sandwich', 'Veg Sandwich', 40.0, 'veg', 'veg_sandwich_new.png', 'SANDWICH'),
        (3, 'Veg Club', 'Veg Club Sandwich', 50.0, 'veg', 'club_sandwich_sip.png', 'SANDWICH'),
        (3, 'Veg Cheese Sandwich', 'Veg Cheese Sandwich', 50.0, 'veg', 'veg_sandwich_new.png', 'SANDWICH'),
        (3, 'Veg Mayo Sandwich', 'Veg Mayo Sandwich', 50.0, 'veg', 'veg_sandwich_new.png', 'SANDWICH'),
        (3, 'Special Club Sandwich', 'Special Club Sandwich', 70.0, 'veg', 'club_sandwich_sip.png', 'SANDWICH'),
        (3, 'Falafel Sandwich', 'Falafel Sandwich', 50.0, 'veg', 'falafel_sandwich_sip.png', 'SANDWICH'),
        (3, 'Crunchy Cheese Toast', 'Crunchy Cheese Toast', 60.0, 'veg', 'cheese_toast_sip.png', 'SANDWICH'),
        (3, 'Chilli Cheese Sandwich', 'Chilli Cheese Sandwich', 50.0, 'veg', 'chilli_cheese_sandwich_new.png', 'SANDWICH'),
        ...
        (3, 'Black Tea', 'Black Tea', 10.0, 'beverage', 'black_tea_new.png', 'TEA & COFFEE ITEMS'),
        (3, 'Black Ginger Tea', 'Black Ginger Tea', 20.0, 'beverage', 'black_tea_new.png', 'TEA & COFFEE ITEMS'),
        (3, 'Horlicks', 'Horlicks', 20.0, 'beverage', 'horlicks_new.png', 'TEA & COFFEE ITEMS'),
        (3, 'Boost', 'Boost', 20.0, 'beverage', 'boost_new.png', 'TEA & COFFEE ITEMS'),

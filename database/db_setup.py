...
def init_db():
    ...
    vidhyarthi_khaana_items = [
        ...
        (1, 'Vanilla Milk Shake', 'Vanilla Milk Shake', 60.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Strawberry Milk Shake', 'Strawberry Milk Shake', 60.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Butter Scotch Milk Shake', 'Butter Scotch Milk Shake', 60.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Black Currant Milk Shake', 'Black Currant Milk Shake', 60.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Chocolate Milk Shake', 'Chocolate Milk Shake', 60.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Tutti Fruity Milk Shake', 'Tutti Fruity Milk Shake', 60.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Mango Milk Shake', 'Mango Milk Shake', 60.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Vanilla Choco Chips Milk Shake', 'Vanilla Choco Chips Milk Shake', 60.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Pista Badam Milk Shake', 'Pista Badam Milk Shake', 60.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Lychee Milk Shake', 'Lychee Milk Shake', 60.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Kesar Pista Milk Shake', 'Kesar Pista Milk Shake', 60.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Cold Coffee', 'Cold Coffee', 60.0, 'beverage', 'cold_coffee.png', 'ICE CREAM / MILK SHAKE'),
        (1, 'Tender Coconut Milkshake', 'Tender Coconut Milkshake', 70.0, 'beverage', 'milkshake.jpg', 'ICE CREAM / MILK SHAKE'),
        (1, 'Vanilla / Strawberry / Butter Scotch / Black Currant / Tutti Fruity / Chocolate / Pista Badam', 'Vanilla / Strawberry / Butter Scotch / Black Currant / Tutti Fruity / Chocolate / Pista Badam', 38.0, 'beverage', 'icecream.jpg', 'Cone Ice Cream'),
        (1, 'Omlet', 'Omlet', 35.0, 'non-veg', 'plain_omelette.jpg', 'Egg Omlet'),
        (1, 'Bread Omlet', 'Bread Omlet', 40.0, 'non-veg', 'bread_omelette.jpg', 'Egg Omlet'),
        (1, 'Cheese Omlet', 'Cheese Omlet', 45.0, 'non-veg', 'cheese_omelette.jpg', 'Egg Omlet'),
        (1, 'Bread Omlet with Cheese', 'Bread Omlet with Cheese', 50.0, 'non-veg', 'bread_omelette.jpg', 'Egg Omlet'),
        (1, 'Corn Omlet', 'Corn Omlet', 50.0, 'non-veg', 'plain_omelette.jpg', 'Egg Omlet'),
        (1, 'Corn Omlet with Cheese', 'Corn Omlet with Cheese', 55.0, 'non-veg', 'cheese_omelette.jpg', 'Egg Omlet'),
        (1, 'Paneer Cheese Omlet', 'Paneer Cheese Omlet', 60.0, 'non-veg', 'cheese_omelette.jpg', 'Egg Omlet'),
        (1, 'Mushroom Omlet', 'Mushroom Omlet', 45.0, 'non-veg', 'plain_omelette.jpg', 'Egg Omlet'),
        (1, 'Mushroom Cheese Omlet', 'Mushroom Cheese Omlet', 50.0, 'non-veg', 'cheese_omelette.jpg', 'Egg Omlet'),
        (1, 'Lime Cheese Omlet', 'Lime Cheese Omlet', 45.0, 'non-veg', 'cheese_omelette.jpg', 'Egg Omlet'),
        (1, 'Egg Burji', 'Egg Burji', 40.0, 'non-veg', 'egg_burji.jpg', 'Egg + Bread Items'),
        (1, 'Bread Burji', 'Bread Burji', 40.0, 'veg', 'sandwich.jpg', 'Egg + Bread Items'),
        (1, 'Bread Egg Burji', 'Bread Egg Burji', 50.0, 'non-veg', 'egg_burji.jpg', 'Egg + Bread Items'),
        (1, 'Bread Paneer Egg Burji', 'Bread Paneer Egg Burji', 55.0, 'non-veg', 'egg_burji.jpg', 'Egg + Bread Items'),
        ...
        (1, 'Veg Egg Roll', 'Veg Egg Roll', 50.0, 'non-veg', 'egg_burji.jpg', 'Rolls'),
        (1, 'Egg Cheese Roll', 'Egg Cheese Roll', 55.0, 'non-veg', 'egg_burji.jpg', 'Rolls'),
    ...
    gowdas_canteen_items = [
        # ENERGY ZONE
        (2, 'Red Bull Energy Drink', 'Red Bull Energy Drink', 150.0, 'beverage', 'coke_new.png', 'ENERGY ZONE'),
        (2, 'Red Bull Sugar Free', 'Red Bull Sugar Free', 150.0, 'beverage', 'coke_new.png', 'ENERGY ZONE'),
        (2, 'Red Bull Yellow Edition', 'Red Bull Yellow Edition', 175.0, 'beverage', 'coke_new.png', 'ENERGY ZONE'),
        ...
        (2, 'Chicken Roll', 'Chicken Roll', 75.0, 'non-veg', 'egg_roll_new.png', 'ROLLS'),
        (2, 'Chicken Roll with Cheese', 'Chicken Roll with Cheese', 95.0, 'non-veg', 'egg_roll_new.png', 'ROLLS'),
        ...
        (2, 'Mushroom Roll', 'Mushroom Roll', 75.0, 'veg', 'veg_roll_new.png', 'ROLLS'),
        (2, 'Mushroom Roll with Cheese', 'Mushroom Roll with Cheese', 95.0, 'veg', 'veg_roll_new.png', 'ROLLS'),
        
        # MASALA MAGGI
        (2, 'Masala Cooking Maggi', 'Masala Cooking Maggi', 35.0, 'veg', 'maggie.jpg', 'MASALA MAGGI'),
        (2, 'Masala Cooking Maggi Cheese', 'Masala Cooking Maggi with Cheese', 50.0, 'veg', 'maggie.jpg', 'MASALA MAGGI'),
        (2, 'Egg Masala Maggi', 'Egg Masala Maggi', 50.0, 'non-veg', 'maggie.jpg', 'MASALA MAGGI'),
        (2, 'Egg Masala Maggi Cheese', 'Egg Masala Maggi with Cheese', 65.0, 'non-veg', 'maggie.jpg', 'MASALA MAGGI'),
        (2, 'Paneer Masala Maggi', 'Paneer Masala Maggi', 65.0, 'veg', 'maggie.jpg', 'MASALA MAGGI'),
        (2, 'Paneer Masala Maggi Cheese', 'Paneer Masala Maggi with Cheese', 75.0, 'veg', 'maggie.jpg', 'MASALA MAGGI'),
        (2, 'Chicken Masala Maggi', 'Chicken Masala Maggi', 75.0, 'non-veg', 'maggie.jpg', 'MASALA MAGGI'),
        (2, 'Chicken Masala Maggi Cheese', 'Chicken Masala Maggi with Cheese', 97.0, 'non-veg', 'maggie.jpg', 'MASALA MAGGI'),
        
        # WAI WAI MAGGI
        (2, 'Veg Wai Wai Maggi Masala', 'Veg Wai Wai Maggi Masala', 40.0, 'veg', 'maggie.jpg', 'WAI WAI MAGGI'),
        (2, 'Veg Wai Wai Maggi Masala Cheese', 'Veg Wai Wai Maggi Masala with Cheese', 55.0, 'veg', 'maggie.jpg', 'WAI WAI MAGGI'),
        ...
        (2, 'Veg Hot Dog Omelette', 'Veg Hot Dog with Omelette', 55.0, 'non-veg', 'sandwich.jpg', 'HOT DOGS'),
        ...
        # EGG ITEMS
        (2, 'Bun Omelette Plain', 'Bun Omelette Plain', 35.0, 'non-veg', 'bread_omelette.jpg', 'EGG ITEMS'),
        (2, 'Bun Omelette Cheese & Chips', 'Bun Omelette with Cheese and Chips', 65.0, 'non-veg', 'bread_omelette.jpg', 'EGG ITEMS'),
        ...
        (2, 'Veg Fried Maggi Cheese', 'Veg Fried Maggi with Cheese', 65.0, 'veg', 'maggie.jpg', 'MAGGI SPECIAL'),
        (2, 'Chicken Fried Maggi', 'Chicken Fried Maggi', 75.0, 'non-veg', 'maggie.jpg', 'MAGGI SPECIAL'),
        (2, 'Chicken Fried Maggi Cheese', 'Chicken Fried Maggi with Cheese', 87.0, 'non-veg', 'maggie.jpg', 'MAGGI SPECIAL'),
        (2, 'Egg Fried Maggi', 'Egg Fried Maggi', 55.0, 'non-veg', 'maggie.jpg', 'MAGGI SPECIAL'),
        (2, 'Egg Fried Maggi Cheese', 'Egg Fried Maggi with Cheese', 65.0, 'non-veg', 'maggie.jpg', 'MAGGI SPECIAL'),
    ...
    sip_snack_cafe_items = [
        ...
        (3, 'Paneer Roll', 'Paneer Roll', 50.0, 'veg', 'frankie.jpg', 'ROLLS'),
        (3, 'Paneer Cheese Roll', 'Paneer Cheese Roll', 60.0, 'veg', 'frankie.jpg', 'ROLLS'),
        (3, 'Falafel Roll', 'Falafel Roll', 50.0, 'veg', 'veg_roll_new.png', 'ROLLS'),
        (3, 'Mushroom Roll', 'Mushroom Roll', 50.0, 'veg', 'veg_roll_new.png', 'ROLLS'),
        ...
        (3, 'Vada Pav', 'Vada Pav', 30.0, 'veg', 'vada.jpg', 'SNACKS'),
        ...
        # MAGGI
        (3, 'Veg Maggi', 'Veg Maggi', 50.0, 'veg', 'maggie.jpg', 'MAGGI'),
        (3, 'Paneer Maggi', 'Paneer Maggi', 50.0, 'veg', 'maggie.jpg', 'MAGGI'),
        (3, 'Plain Maggi', 'Plain Maggi', 35.0, 'veg', 'maggie.jpg', 'MAGGI'),
        (3, 'Cheese Maggi', 'Cheese Maggi', 50.0, 'veg', 'maggie.jpg', 'MAGGI'),
        (3, 'Corn Maggi', 'Corn Maggi', 60.0, 'veg', 'maggie.jpg', 'MAGGI'),
    ]
